...
```{r cwrulogo-fig, echo = FALSE, out.width = '33%'}
...
1. Nate Silver's The Signal and The Noise ISBN-13: 978-1594204111, and 
2. Jeff Leek's The Elements of Data Analytic Style, available at https://leanpub.com/datastyle.

## Free Resources You'll Need To Get

1. OpenIntro Statistics (OpenStats) by David Diez, Christopher Barr and Mine Cetinkaya-Rundel, download at https://www.openintro.org/stat/textbook.php?stat_book=os 
2. R for Data Science (R4DS) by Garrett Grolemund and Hadley Wickham, which may be read at http://r4ds.had.co.nz/
...
You'll note that the Topics listed here are mainly suggestions. The course divides neatly into three parts.
...
For more details on what will be covered within each Part of the course, [Dr. Love's Notes](https://thomaselove.github.io/431notes/) for the course.

Class | Date | Topics | Notes
-----: | --------: | ------------------------------------- | -------
1 | 2017-08-29 | Introduction, Getting Started | Syllabus
2 | 2017-08-31 | Part A. Visualizing Data, R and R Studio | [R4DS](http://r4ds.had.co.nz/) 1, 2
3 | 2017-09-05 | Exploring Data and the Tidyverse | [R4DS](http://r4ds.had.co.nz/) 3, 4, [OpenStats](https://www.openintro.org/stat/textbook.php?stat_book=os) 1
4 | 2017-09-07 | (**Room E401**) Scripts and Projects in R/R Studio | [R4DS](http://r4ds.had.co.nz/) 6, 8
5 | 2017-09-12 | Data Transformation and dplyr | [R4DS](http://r4ds.had.co.nz/) 5
6 | 2017-09-14 | Exploratory Data Analysis | [R4DS](http://r4ds.had.co.nz/) 7
7 | 2017-09-19 | Descriptive Statistics, The Normal Distribution | [OpenStats](https://www.openintro.org/stat/textbook.php?stat_book=os) 3
8 | 2017-09-21 | Using ggplot2 more effectively |
9 | 2017-09-26 | Linear regression and correlation | [OpenStats](https://www.openintro.org/stat/textbook.php?stat_book=os) 7
10 | 2017-09-28 | Studying associations |
11 | 2017-10-03 | Part B: Making Comparisons | [OpenStats](https://www.openintro.org/stat/textbook.php?stat_book=os) 4
12 | 2017-10-05 | Confidence intervals | [OpenStats](https://www.openintro.org/stat/textbook.php?stat_book=os) 4
13 | 2017-10-10 | Matched Pairs, Independent Samples
14 | 2017-10-12 | Hypothesis Testing |
15 | 2017-10-17 | Building Statistical Inferences, ANOVA | Faraway 16
16 | 2017-10-19 | More Complex Inferential Settings | 
-- | *2017-10-24* | *CWRU Fall Break (no class)*
17 | 2017-10-26 | Building Inferences for Rates | [OpenStats](https://www.openintro.org/stat/textbook.php?stat_book=os) 6
18 | 2017-10-31 | Tables and Associations |
19 | 2017-11-02 | Part C: Building Effective Models | [OpenStats](https://www.openintro.org/stat/textbook.php?stat_book=os) 7-8
20 | 2017-11-07 | Regression |
21 | 2017-11-09 | More Regression | 
22 | 2017-11-14 | Even more Regression |
23 | 2017-11-16 | Still more Regression |
-- | *2017-11-21* | *Class is cancelled.*
-- | *2017-11-23* | *CWRU Thanksgiving Break (no class)*
24 | 2017-11-28 | Post-Thanksgiving Regression |
25 | 2017-11-30 | Prediction and Classification |
26 | 2017-12-05 | Detailed Case Study |
27 | 2017-12-07 | Looking Back, and Forward |
...
Your portfolio presentation time will be scheduled in October.

## Topics Discussed Extensively in 431 and its follow-up, 432

1. Exploratory Data Analysis: "All graphs are comparisons" including data exploration,
statistical graphics and more general visualization of information.
2. Placing biological, medical and health research questions into a statistical framework.
3. Study Development - making choices in designing and executing the collection and
aggregation of data.
4. Data Handling - including important issues in importing, tidying and transforming
data, as well as methods for dealing with missing data, including imputation.
5. Statistical Comparisons: "All of statistics are comparisons" - including methods for
discrete and continuous variables: intervals, assumptions, some thoughts on statistical
power, and the bootstrap, design of visualizations and models for rates, proportions
...
7. Using R and R Studio to make all of the things above happen; with particular emphasis
on doing replicable research and using Markdown to document the work.
...
- Program Lead for Health Care Analytics, MS in Biostatistics, Department of Population and Quantitative Health Sciences, CWRU
...
Dr. Love is generally available before and after class, otherwise by appointment.
