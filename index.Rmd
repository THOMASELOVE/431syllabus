...
1. Dr. Love's document [Working with Data in R Studio](https://github.com/THOMASELOVE/431/blob/master/431_2017_working-with-data-in-R.md) might be a good first step. This is basically a demonstration of how to use these tools to actually analyze data.
2. Dr. Love also prepared a downloadable template for your first few R Markdown attempts. The template is also described in the [Working with Data in R Studio](https://github.com/THOMASELOVE/431/blob/master/431_2017_working-with-data-in-R.md) document, and can be obtained by downloading the data and code for the course. Again, Data and code downloads are at https://github.com/THOMASELOVE/431data. Click on the green Clone or download button, and then select Download ZIP to obtain a Zip file of the latest materials.
